...
export const MOCK_WAGER_SWAP_POOL_ADDRESS = "0x00000000000000000000000000000000008dbf27";
export const MOCK_WAGER_GAMES_ADDRESS     = "0x00000000000000000000000000000000008dc261";
