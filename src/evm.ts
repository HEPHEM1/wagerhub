...
export const EVM_USDC_ADDRESS = "0x0000000000000000000000000000000000869923"; // 0.0.8819491 - Mock USDC (WagerHub)
export const EVM_USDT_ADDRESS = "0x0000000000000000000000000000000000869922"; // 0.0.8819490 - Mock USDT (WagerHub)
